...
export function Sidebar({ className }: SidebarProps) {
  ...
  return (
    <div
      className={cn(
        "border-r bg-white min-h-screen flex flex-col relative",
        className,
      )}
    >
        ...
        <div className="px-3 py-2">
          <h2
            className={cn(
              ...
              isCollapsed
                ? "md:px-2 md:text-center md:text-xl px-4 text-2xl"
                : "px-4 text-2xl",
            )}
          >
            <span className={cn(isCollapsed ? "hidden md:inline" : "hidden")}>
              SF
            </span>
            <span className={cn(isCollapsed ? "md:hidden inline" : "inline")}>
              SmartFit
            </span>
          </h2>
            ...
            {routes.map((route) => (
              <Link
                ...
                className={cn(
                  ...
                  isCollapsed
                    ? "md:justify-center md:p-2 gap-3 px-3 py-2"
                    : "gap-3 px-3 py-2",
                  route.active
              ...
              >
                ...
                />
                <span
                  className={cn(isCollapsed ? "md:hidden inline" : "inline")}
                >
                  {route.label}
                </span>
              </Link>
